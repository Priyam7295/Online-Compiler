...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError('An error occurred while processing the request. Probably check Syntax');
    }
  }
  ...
  return (
    <div className="container">
      ...
      <select className="select-box" value={selectedLanguage} onChange={handleLanguageChange}>
